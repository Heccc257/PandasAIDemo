## PandasAIDemo
一个基于pandasAI库的代理程序，主要设计了一个可交互的cli，并设计了更丰富的功能。项目地址 `https://github.com/Heccc257/PandasAIDemo`
* 用户可以指定添加csv表格，或者指定目录添加目录下的所有csv表格
* 删除表格
* 进行基础的chat操作，包括基础问题回答和画图
* 输出问答的history
* 支持表格join等操作，并且将得到的新表格输出到本地
### 实例
